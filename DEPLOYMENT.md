...
4. [Logto Configuration](#logto-configuration)
5. [Directus Configuration](#directus-configuration)
...
│                         EXTERNAL SERVICES                       │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐       │
│  │  Logto   │  │  OpenAI  │  │  Stripe  │  │ Cloudflare│       │
│  │  (Auth)  │  │  (AI)    │  │(Payments)│  │   R2      │       │
│  └──────────┘  └──────────┘  └──────────┘  └──────────┘       │
└─────────────────────────────────────────────────────────────────┘
```
...
### Step 1: Create Logto Account

1. Go to [logto.io](https://logto.io)
2. Create free account
3. Create new tenant (production)
...
3. Copy credentials:
   ...
   - **Issuer endpoint** → `LOGTO_ENDPOINT`

### Step 4: Create API Resource

1. Go to **API Resources** → **Create API**
2. Name: `Agent AI API`
3. Identifier: `https://yourdomain.com/api`

### Step 5: Create Roles

1. Go to **User Management** → **Roles**
2. Create roles matching our RBAC:
   - `super_admin`
   - `owner`
   - `admin`
   - `member`
...
```
LOGTO_ENDPOINT=https://your-logto-tenant.logto.app
LOGTO_APP_ID=your-app-id
LOGTO_APP_SECRET=your-app-secret
LOGTO_COOKIE_SECRET=generate-a-random-32-char-string
```
...
LOGTO_APP_ID=your-app-id
LOGTO_APP_SECRET=your-app-secret
LOGTO_COOKIE_SECRET=your-random-32-char-secret
