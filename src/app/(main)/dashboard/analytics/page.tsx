...
import type { TopQuestion, UnansweredQuestion, WorkspaceAnalyticsKPIs } from "@/lib/db/repositories/analytics.repo";
...
export default function AnalyticsPage() {
  const [kpis, setKpis] = useState<WorkspaceAnalyticsKPIs | null>(null);
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KPICard
          ...
          value={kpis.avgResponseTimeMs ? `${Math.round(kpis.avgResponseTimeMs / 1000)}s` : "—"}
        ...
        <div className="rounded-lg border bg-background p-4">
          ...
          {topQuestions.length === 0 ? (
            ...
            <div className="space-y-2">
              {topQuestions.map((q) => (
                <div key={q.question} className="flex items-center justify-between rounded-md bg-muted/50 px-3 py-2">
